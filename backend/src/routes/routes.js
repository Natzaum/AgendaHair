...
route.post("/provider-tool/services/:id/update", provideValidator.updateSchema, provideController.postUser)
route.delete("/provider-tool/services/:id/delete", provideValidator.deleteSchema, provideController.deleteUser)
